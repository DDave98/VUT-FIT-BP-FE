...
{
    return (
        <footer className="text-center lg:text-left bg-gray-900 text-gray-200">
            ...
            <div className="text-center p-6 bg-gray-600">
                ...
                <a className="text-gray-200 font-semibold" href="https://tailwind-elements.com/">Tailwind Elements</a>
            </div>
            </footer>
    );
};
